const getVisibleExpenses = (
  expenses,
  { text, sortBy, startDate, endDate, amount }
) => {
  return expenses
    .filter((expense) => {
...
}; // see docs for reduce usage: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce
